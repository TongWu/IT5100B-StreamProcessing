...
public class FraudDetector extends KeyedProcessFunction<Integer, KafkaEvent, KafkaEvent> {
    ...
    @Override
    public void processElement(KafkaEvent value, KeyedProcessFunction<Integer, KafkaEvent, KafkaEvent>.Context ctx, Collector<KafkaEvent> out) throws Exception {
